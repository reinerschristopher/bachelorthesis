...
\section{Numerische Formulierung des UMAP Verfahrens} \label{seq:numerische_formulierung}
   ...
   Wir werden nun die $\Yrep$ aus Gleichung (\ref{eq:lowrep}) konstruieren. Dafür setzen wir 
   ...
   Gleichung (\ref{eq:di}) durchzuführen. 

   $\Psi$ ist dabei allerdings bei min-dist nicht differenzierbar. Somit betrachten wir eine stetige Approximation von $\Psi$,
