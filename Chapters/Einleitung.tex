...
%\section{Einleitung}
	\textit{DREI SÄTZE ÜBER DIE RELEVANZ VON HOCHDIMENSIONALEN DATEN IN DER HEUTIGEN GESELLSCHAFT.} % TODO: Was macht das Thema Dimensionsreduktion relevant?
...
\subsection*{Aufbau der Arbeit}
	In Kapitel \ref{Grundlagen} werden wir die für das UMAP Verfahren benötigten Definitionen und Sätze geben. 
	Dabei werden wir zuerst auf den Begriff der riemannschen Mannigfaltigkeit hinarbeiten, dieser legt aufgrund 
	der Mannigfaltigkeit-Hypothese die  Grundlage für weitere Überlegungen. Dann werden \textit{Kategorien} 
	und wichtige Aussagen der Kategorientheorie. Mithilfe von Kategorien können wir dann \textit{simpliziale Mengen} 
	...
	Die Aussagen werden uns in Kapitel \ref{UMAP} dabei helfen die Theorie des UMAP Verfahrens darzustellen. 
