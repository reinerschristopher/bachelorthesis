...
% Bisher: Daten -> metr. Räume -> fuzzy simplicial sets
% Ziel:   Daten -> metr. Räume -> VR complex
...
% \section{Einleitung}
In diesem Kapitel werden wir die aus Kapitel \ref{Grundlagen} erlangten Grundlagen verwenden, um 
eine geeignete topologische Repräsentation unserer Daten $X=\seqx$ zu erlangen. Eine ähnliche 
Repräsentation werden wir von einem $d$-dimensionalen Raum $(d \ll D)$ betrachten, um dann mit einem geeigneten 
Begriff des Abstandes der beiden Repräsentationen die niedrigdimensionale Repräsentation der 
hochdimensionalen anzupassen. Dies wird uns zum UMAP Verfahren führen. 
% TODO: Ergänzungen hier erwähnen oder in \ref{Implementierung}?

%----------------------------------------------------------------------------------------

\section{Topologische Repräsentation}
	Blabla bla
...
%-----------------------------------
	...
	Was das bedeutet und wie das UMAP Verfahren diesen zu vermeidet, werde ich im Folgenden kurz erklären.
...
% Siehe Oudot s.48, funktioniert noch nicht für Filtrationen. 
