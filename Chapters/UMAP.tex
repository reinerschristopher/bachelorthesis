...
\section{Topologische Repräsentation} \label{sec:repr}
	...
	der $\mathbf{x}_i$, bevorzugt dabei allerdings stark die lokalen Abstände. Dies spiegelt Aussage des Lemma \ref{lem:geod} wieder, dass wir nur lokal 
	zu $\mathbf{x}_i$ die Geodäte bestimmen können. 
...
% Zeitplan:
% Sa: Kapitel 2,3,4 vervollständigen, Einleitun und Appendix schreiben
