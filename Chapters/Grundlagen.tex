...
\begin{ex}
	$S^n$ ist eine $n$-dimensionale Manngifaltigkeit im $\R^{n+1}$.
\end{ex}
...
einer niedirgdimensionalen Struktur entnommen ist, zu formalisieren.
...
Eine bekannte Aussage, welche der Topologie enstammt, ist, dass eine Kaffeetasse das Gleiche topologische 
Objekt wie ein Donout ist. Dies ist dadurch begründet, dass man eine Kaffeetasse durch strecken und stauchen 
(ohne reißen) in einen Donout transormieren kann. Diese \enquote{Gleichheit} lässt sich wie folgt mathematisch 
darstellen:
...
\begin{ex}
	Die Homologiegruppen eines Balls, Dounuts, Graphen, ...
\end{ex}
...
\begin{rem}
	...
	zugehörige 1-Skelet. Dann erhällt man $V$ aus $V^1$, indem man alle Cliquen im 
