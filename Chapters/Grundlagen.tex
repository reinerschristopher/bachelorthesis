...
\newcommand{\tConorm}{\bot^N_{i=1}}  % Symbol for t-Conorm, $\bot_{\{1 \leq i \leq N\}}$ $\underset{i=1}{\overset{N}{\bot}}$ $\bot^N_{i=1}$
...
% TODO: Daniel 
% Section 2:
% Section 2.2: Man könnte noch zitieren in welchem Paper Samuel Eilenberg und Saunders Mac Lane Kategorientheorie eingeführt haben.

% Bemerkung über Klassen: Ich würde den Satz "Eine Klasse ist eine Menge, die zu groß ist um eine Menge zu sein." ändern. Evtl. sowas wie: Bei Klassen kann es sich um Ansammlungen von Objekten handeln, die "größer" als Mengen sind.

% Bei der Definition des Kompositionsoperators für die duale Kategorie steht ein Hom(C,B) zu viel da.
...
% 														Das würde doch heißen, dass jeder Punkt aus z.b. S^1 auch in S^0 ist (?)
...
\section{Kategorientheorie} \label{seq:cat}
	...
	\begin{ex}
		\textit{Passende Beispiele von Kategorien, welche später wieder genutzt werden. $\Top, \Set, (Fin)EPMet$} 
...
\section{Unscharfe Mengen} \label{seq:fuzz}
	...
	% TODO: normale und ketegorien Definition Fuzz und übersetzung von Garbe nach normal
